...
Chi square tests indicate that the differences in raw material proportions between all three assemblages are highly significant (p = `r chsq_pval`), although the differences in technological composition are not significant (p = `r round(lens_differences_tech_plot$tech_chi$p.value, 3)`), most likely due to small sample size (n = .  
