...
lithics <- read.csv(paste0(directory, "data/Lithics_table_from_paper_on_1989_dig.csv"))
...
library(knitr)
invisible(purl('analysis-of-C14-TL-OSL-dates-from-1989-excavations.Rmd', output="temp", quiet=TRUE))
read_chunk("temp")
```
...
ggsave(file = paste0(directory, "figures/lithics_proportions_from_1989_for_paper.svg"))
```