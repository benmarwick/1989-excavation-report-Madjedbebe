...
# Supplementary details supporting the analysis of OSL, TL and radiocarbon ages from the 1989 excavations at Madjebebe (Malakanunja II)
...
Bayesian change point analysis indicates that sedimentation rates slow substantially below 2.0 m to the base of occupation (posterior probability of change is  `r round(bayes_cp_result[1,]$"cp$posterior.prob",3)` at `r round(bayes_cp_result[1,]$age2plot,0)` ka cal BP) and then accelerate again below the lowest occupation (posterior probability of change is `r round(bayes_cp_result[2,]$"cp$posterior.prob",3)` at `r round(bayes_cp_result[2,]$age2plot,0)` ka).
